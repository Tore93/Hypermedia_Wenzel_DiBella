...
--
-- Host: localhost
-- Generation Time: Lug 19, 2016 alle 16:20
...
--
-- Struttura della tabella `Assistant_Service`
--

CREATE TABLE IF NOT EXISTS `Assistant_Service` (
  `Id assistantService` int(11) NOT NULL AUTO_INCREMENT,
  `Type_Category` int(70) DEFAULT NULL,
  `Pre_Description` varchar(200) CHARACTER SET utf8 DEFAULT NULL,
  `Name` varchar(60) CHARACTER SET utf8 DEFAULT NULL,
  `inHighlights` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `AS_Offered` (
  `Id` int(11) NOT NULL,
  `Id_AssistantService` varchar(250) CHARACTER SET utf8 NOT NULL,
  PRIMARY KEY (`Id`,`Id_AssistantService`)
...
INSERT INTO `AS_Offered` (`Id`, `Id_AssistantService`) VALUES
(1, 'Cost control and payments'),
(2, 'Cost control and payments'),
(3, 'Line management & services'),
(3, 'Smart Life'),
(3, 'Technical support & configuration'),
(4, 'Line management & services'),
(4, 'Technical support & configuration'),
(5, 'Cost control and payments'),
(6, 'Smart Life');
...
CREATE TABLE IF NOT EXISTS `Device` (
  ...
  `Initial_Description` text CHARACTER SET utf8,
  ...
  `Operational_System` varchar(75) CHARACTER SET utf8 DEFAULT NULL,
  ...
  `Tension_Stabilizator` varchar(75) CHARACTER SET utf8 DEFAULT NULL,
  `Operating_Enviroment` varchar(75) CHARACTER SET utf8 DEFAULT NULL,
  `Wi_Fi` varchar(75) CHARACTER SET utf8 DEFAULT NULL,
  `Interfaces` varchar(350) CHARACTER SET utf8 DEFAULT NULL,
  `Wireless_Protection` varchar(75) CHARACTER SET utf8 DEFAULT NULL,
  `Advance_Option` varchar(350) CHARACTER SET utf8 DEFAULT NULL,
...
INSERT INTO `Device` (`Id`, `Name`, `Type_Category`, `Initial_Description`, `Photo`, `Display`, `Sensor`, `Processor`, `Camera`, `Video`, `Connectivity`, `Battery`, `Operational_System`, `Audio`, `Picture`, `Memory`, `Weight`, `Size`, `Tecnology`, `Cooling`, `Noise`, `Tension_Stabilizator`, `Operating_Enviroment`, `Wi_Fi`, `Interfaces`, `Wireless_Protection`, `Advance_Option`, `InPromotion`, `InOutlet`) VALUES
...
INSERT INTO `Device_Category` (`Id_category`, `Description`, `Name`) VALUES
...
INSERT INTO `Photo` (`Name`, `Path`, `Id`) VALUES
('Tablet e computer', '../image/tablet_e_pc.png', 1),
('Smartphone e telefoni', '../image/smartphone_e_telofoni.png', 2),
('Modem e networking', '../image/Modem_e_networking.png', 3),
('TV e Smart Living', '../image/Tv_e_smart_living.png', 4),
('Outlet', '../image/outlet.png', 5),
('Promotions', '../image/Promotions.gif', 6),
('iPad Air 2 16GB', '../image/ipad-air-2-silver-1.jpg', 7),
('Samsung Galaxy TAB A 9.7', '../image/samsung_galaxy_tab_S2_black-1.png', 8),
('Huawei P9', '../image/huawei-p9-grey-02.jpg', 9),
('Apple iPhone 6', '../image/apple-iPhone6s_Gld-1.png', 10),
('Modem ADSL Wi-Fi', '../image/blocchetto-modem-adsl-new.png', 11),
('Gear VR', '../image/gear_vr_1_760x760.jpg', 12),
('Serie A TIM', '../image/SL_serieA.jpg', 37),
('TimGames', '../image/SL_game.png', 36),
('TimReading', '../image/SL_read.png', 35),
('TiMusic', '../image/SL_music.png', 34),
('Highlights', '../image/AShighlights.png', 32),
('Technical support & configuration', '../image/AStechnicalSupport.png', 30),
('Smart Life', '../image/ASsmartLife.png', 31),
('Cost control and payments', '../image/AScost_cont.png', 29),
('TV-TIMVision', '../image/2.png', 33),
('Line management & services', '../image/ASline_management.png', 28);

-- --------------------------------------------------------

--
-- Struttura della tabella `PhotoPerCategory`
--

CREATE TABLE IF NOT EXISTS `PhotoPerCategory` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `Path` text CHARACTER SET utf8 NOT NULL,
...
--
-- Dump dei dati per la tabella `PhotoPerCategory`
--

INSERT INTO `PhotoPerCategory` (`Id`, `Path`, `Category`) VALUES
(1, '../image/ipad-air-2-silver-2.jpg', 'Tablet e computer'),
(2, '../image/samsung_galaxy_tab_S2_black-2.png', 'Tablet e computer'),
(3, 'Smartphone e telefoni', '../image/huawei-p9-grey-03.jpg'),
(4, '../image/apple-iPhone6s_Gld-2.jpg.png', 'Smartphone e telefoni'),
(5, '../image/blocchetto-modem-adsl-new.png', 'Modem e networking'),
(6, '../image/gear_vr_2_760x760.jpg', 'TV e Smart Living'),
(7, '../image/outlet.png', 'Outlet'),
(8, '../image/Promotions.gif', 'Promotions');

-- --------------------------------------------------------

--
-- Struttura della tabella `PhotoPerDevice`
--

CREATE TABLE IF NOT EXISTS `PhotoPerDevice` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dump dei dati per la tabella `PhotoPerDevice`
--

INSERT INTO `PhotoPerDevice` (`Id`, `Name`, `Path`) VALUES
(1, 'iPad Air 2 16GB', '../image/ipad-air-2-silver-2.jpg'),
(2, 'iPad Air 2 16GB', '../image/ipad-air-2-silver-3.jpg'),
(3, 'iPad Air 2 16GB', '../image/ipad-air2.jpg'),
(4, 'Samsung Galaxy TAB A 9.7', '../image/samsung_galaxy_tab_S2_black-2.png'),
(5, 'Samsung Galaxy TAB A 9.7', '../image/samsung_galaxy_tab_S2_black-3.png'),
(6, 'Huawei P9', '../image/huawei-p9-grey-03.jpg'),
(7, 'Huawei P9', '../image/huawei-p9-grey-04.jpg'),
(8, 'Huawei P9', '../image/huawei.jpg'),
(9, 'Apple iPhone 6', '../image/apple-iPhone6s_Gld-2.jpg.png'),
(10, 'Apple iPhone 6', '../image/apple-iPhone6s_Gld-3.jpg'),
(11, 'Apple iPhone 6', '../image/apple-iPhone6s_Gld-4.jpg'),
(12, 'Gear VR', '../image/gear_vr_2_760x760.jpg'),
(13, 'Gear VR', '../image/gear_vr_3_230x230.png'),
(14, 'Gear VR', '../image/gear_vr_4_760x760.jpg');

-- --------------------------------------------------------

--
-- Struttura della tabella `PhotoPerSL`
--

CREATE TABLE IF NOT EXISTS `PhotoPerSL` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `Name` text CHARACTER SET utf8 NOT NULL,
  `Path` text CHARACTER SET utf8 NOT NULL,
  `Title` varchar(300) CHARACTER SET utf8 NOT NULL,
  `Initial_Desc` text CHARACTER SET utf8 NOT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=16 ;

--
-- Dump dei dati per la tabella `PhotoPerSL`
--

INSERT INTO `PhotoPerSL` (`Id`, `Name`, `Path`, `Title`, `Initial_Desc`) VALUES
(1, 'TV-TIMVision', '../image/cinema.jpg', 'Cinema', 'Sit back and enjoy great cinema!!\r\n\r\nA varied selection of films with the most anticipated premieres, the great classics, unreleased, action films, thrillers, comedies and animation for the whole family. In addition to HD, to make every spectacular image and not miss a single detail'),
(2, 'TV-TIMVision', '../image/documentari.jpg', 'Documentari', 'La natura e il mondo visti da vicino!!\r\n\r\nUna ricca offerta con i migliori documentari per attraversare luoghi incontaminati ed avere uno sguardo attento alla natura, rivedere la grande storia del passato per aiutarci a non dimenticare e incontrare personaggi famosi comodamente a casa'),
(3, 'TV-TIMVision', '../image/serieTV.jpg', 'Tv Series', 'Una puntata tira l’altra!!\r\n\r\nTutti gli episodi delle migliori serie TV, dalle più famose alle più esclusive, disponibili immediatamente e da vedere tutte d’un fiato e, per non interrompere la tua maratona, puoi guardare TIMvision anche sul WEB, su Smartphone e Tablet'),
(4, 'TiMusic', '../image/novita-2.jpg', 'News', 'All national and international album releases, often in exclusive preview'),
(5, 'TiMusic', '../image/timMusic_playlist-2.jpg', 'Playlist', 'Tante playlist create per accompagnare ogni momento della tua giornata.'),
(6, 'TiMusic', '../image/top20-2.jpg', 'TOP 20', 'Ogni settimana la classifica dei 20 brani più ascoltati su TIMmusic'),
(7, 'TimReading', '../image/quotidiani.jpg', 'newspapers', 'Would you like to get to work already informed about the latest news? Read Your favorite newspaper anywhere, anytime on Smartphone, Tablet and PC'),
(8, 'TimReading', '../image/magazine.jpg', 'Magazine', 'Fashion, gossip, news, science. What magazine you want to read now? Choose with a click and browse through Tablet and PC'),
(9, 'TimReading', '../image/book.jpg', 'ebook', 'TIMreading has the right book for you. Bestseller, latest news, thriller, romance novels to read on Smartphone, Tablet and PC'),
(10, 'TimGames', '../image/arcade.jpg', 'Arcade', 'The best classics for endless fun!'),
(11, 'TimGames', '../image/carte.jpg', 'Cards!', 'News Sport!!\r\nExperience the thrill of the challenge!'),
(12, 'TimGames', '../image/motori.jpg', 'Cars!', 'News Sport!!\r\nExperience the thrill of the challenge!'),
(13, 'Serie A TIM', '../image/SERIE_A_news.jpg', 'News!', 'A goal leads to another\r\nSee all video-goal, the video synthesis, video-news, and the news video of the championship of Serie A Soccer'),
(14, 'Serie A TIM', '../image/SERIE_A_social.jpg', 'Social', 'Along with TIM share a passion for football!!\r\n\r\nWith the sole of FOOTBALL LEAGUE official app you direct access to the Facebook fan page and Twitter Serie A TIM'),
(15, 'Serie A TIM', '../image/SERIE_A_squadra-del-cuore.jpg', 'Team!!', 'A goal leads to another\r\nSee all video-goal, the video synthesis, video-news, and the news video of the championship of Serie A Soccer');
...
CREATE TABLE IF NOT EXISTS `SL_Category` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `Name` varchar(200) CHARACTER SET utf8 DEFAULT NULL,
  `Activation_FAQ` text CHARACTER SET utf8,
  PRIMARY KEY (`Id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=6 ;
...
INSERT INTO `SL_Category` (`Id`, `Name`, `Activation_FAQ`) VALUES
...
CREATE TABLE IF NOT EXISTS `SL_Offered` (
  `Id` int(11) NOT NULL,
  `Id_SmartLife` varchar(250) CHARACTER SET utf8 NOT NULL,
  PRIMARY KEY (`Id`,`Id_SmartLife`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
INSERT INTO `SL_Offered` (`Id`, `Id_SmartLife`) VALUES
(1, 'Serie A TIM'),
(1, 'TimGames'),
(1, 'TimReading'),
(1, 'TV-TIMVision'),
