...
<script src="https://code.jquery.com/jquery-2.1.1.min.js"></script>
 <script src="../JS/LeftMenuScript.js" type=text/javascript> </script>
        ...
        <script src="../JS/RequestFAQ.js" type="text/javascript"></script>
    ...
    <body>
        ...
        <div id="ALL">
            ...
            <div id="CENTER_RIGHT" class="mainBLOCK">
                ...
                <div class="titleCenter"><h1 >FAQ</h1></div>
                    ...
                    <div id="FAQs">
                        ...
                        <ul>
                         ...
                         <!--   <li >
                                ...
                                <h3>bla bla bla </h3>
                                <p>cicu cubsjhbsa cjshbc asjhcb scjhbasc sjhcabjhcsa jsacbjhbsca sacjhbsca jhsbc sachjbcsa scahb scasacbj </p>
