<html>
    ...
    <head>
        ...
        <script src="../JS/ServicesAboutSpecificSL.js" type="text/javascript"></script>
    ...
    <body>
        ...
        <div id="ALL">
            ...
            <div id="CENTER_RIGHT" class="mainBLOCK">
                ...
                <div class="titleCenter"><h1 >Categories of Smart Life</h1></div>
                ...
                <div class="content">
					...
					<div id="SLbox">
                        ...
                        <img class="BUTTON"  id="bottomNext" src="../image/rght_arrow.png">
                         
                       
                        <img class="BUTTON" id="bottomPrev" src="../image/left_arrow.png">
                   ...
                   <!--     <div class="BUTTON" id="prevCatBUTTON">
                        <a href="CategoryOfSL.php?q="> to prev category</a>
                                <img src="../image/rght_arrow.png"> 
                            
                        </div>-->

                        <div class="BUTTON" id="faqBUTTON"> 
                        <a href="FAQ.php?q=<?php  echo $_GET["q"]; ?>">
                        <img src="../image/FAQ.png">
                        </a>
                        FAQ
                        </div>

                        <div class="BUTTON" id="supportingDevBUTTON">  
                            <a href="devicesSL.php?q=<?php  echo $_GET["q"]; ?>"><img src="../image/supporting_dev.png"></a>
                        </div>

                   <!--     <div class="BUTTON"  id="nextCatBUTTON">
                                  <a href="CategoryOfSL.php?q="> to next category</a>
                                <img src="../image/rght_arrow.png"> 
                            </div>-->
