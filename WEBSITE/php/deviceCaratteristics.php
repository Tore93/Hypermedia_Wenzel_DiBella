<html>
    ...
    <head>
        ...
        <script src="../JS/RequestSpecificCaratteristics.js" type="text/javascript"></script>
    ...
    <body>
        ...
        <div id="ALL">
            ...
            <div id="CENTER_RIGHT" class="mainBLOCK">
                ...
                <div class="titleCenter"><h1 >Device Caratteristics</h1></div>
                ...
                <!--    <div class="caratteristicsRAW"> 
                        <div class="caratteristicsNAME">  <p> NOME CARATTERISTICA </p> </div> 
                        <div class="caratteristicsVALUE">   <p> DESCRIZIONE VALORE </p>  </div>
                    </div>
