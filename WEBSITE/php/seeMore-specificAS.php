<html>
 ...
 <script src="https://code.jquery.com/jquery-2.1.1.min.js"></script>
        ...
        <script src="../JS/RequestSpecificAService.js" type="text/javascript"></script>
        ...
        <div id="ALL">
            ...
            <div id="CENTER_RIGHT" class="mainBLOCK">
                ...
                <div class="content ">
                    ...
                    <div id="ASdescription"> AS description  </div>
       
                   
                  
                    
                    <div id="suppDevicesBUTTON" > 
                    
                     <a href= "devicesAS.php?q=<?php  echo $_GET["q"]; ?>">
                    <img class="BUTTON" id="suppDevicesBUTTON" src="../image/suppDevicesBUTTON.png"> 
                     </a>
