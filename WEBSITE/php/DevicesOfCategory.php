<html>
    ...
    <head>
        ...
        <script src="../JS/DeviceOfCategory.js" type="text/javascript"></script>
    ...
    <body>
        ...
        <div id="ALL">
            ...
            <div id="CENTER_RIGHT" class="mainBLOCK">
                ...
                <div class="content" id="forDevices">

                   <div class="column"> 

                    <!--     <div class="devCategory">
                            
                            <p class="titleCAT" >cacca</p>

                            <img src="../image/tablet_e_pc.png">
