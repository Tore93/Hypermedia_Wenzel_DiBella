...
console.log("cioa");
      ...
      //  dataType: "json", //type of data
        ...
        url: "http://hypermedia2016tim.altervista.org/php7QueryServicesASCategory.php", //Relative or absolute path to file.php file
        data: {id:param},
        ...
        //console.log(response);
           ...
           console.log(json);
            ...
            content=json[0].Title;
            content2=json[0].Initial_Desc;
            //content3="See More";
             $("#AScat > ul > li:nth-child(1) > h3").html(content);    
            console.log(json.length);
           $("#AScat > ul > li > div > ul > li:nth-child(1)").html(content2);
      //      $("#AScat > ul > li:nth-child(1) > ul > li:nth-child(2)").html(content3);
